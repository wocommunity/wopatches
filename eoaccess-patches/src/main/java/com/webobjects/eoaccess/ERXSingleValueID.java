...
/**
 * Gives up the means to plug into toString() and may or may not be a bit
 * faster.
 *
...
public class ERXSingleValueID extends EOKeyGlobalID {
	...
	public static final Class _CLASS = _NSUtilities
			._classWithFullySpecifiedName("com.webobjects.eoaccess.ERXSingleValueID");
	private static final ObjectStreamField serialPersistentFields[] = {
			new ObjectStreamField(SerializationValuesFieldKey, Object[].class) };
	...
	public String toString() {
		...
		if (_value instanceof NSData) {
			result.append("decode('" + byteArrayToHex(((NSData) _value)._bytesNoCopy())
					+ "', 'hex')");
		} else {
	...
	public boolean equals(Object obj) {
		...
		if (thisValue == otherValue
				|| hashCode() == other.hashCode() && thisValue.hashCode() == otherValue.hashCode()) {
	...
	public static EOKeyGlobalID globalIDWithEntityName(String entityName, Object values[]) {
		if (optimize == null) {
			optimize = Boolean.valueOf(System.getProperty("er.extensions.ERXGlobalID.optimize", "false"));
		}
